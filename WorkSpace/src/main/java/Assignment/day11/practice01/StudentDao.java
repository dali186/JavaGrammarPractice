package Assignment.day11.practice01;

import Assignment.day11.practice01.Exception.DuplicateKeyException;
...
public class StudentDao {
    ...
    public Student insert(String key, Student student){
        ...
        try {
            if (student == null || key == null) throw new NoSuchElementException("Key or Student is null");
            if (map.containsKey(key)) throw new DuplicateKeyException("Key is already exists");
